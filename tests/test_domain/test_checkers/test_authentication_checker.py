...
class TestCheckUserIsAuthenticated:
    ...
    async def test_unauthorised_user(self):
        ...
        # Act
        result = await check_user_is_authenticated(self.func)(self, self.update, self.context)
    ...
    @pytest.mark.asyncio
    async def test_not_authenticated_user(self):
        # Arrange
    ...
    async def test_authenticated_user(self):
        ...
        # Act
        await check_user_is_authenticated(self.func)(self, self.update, self.context)
