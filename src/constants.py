...
MEDIA_SELECTED, QUALITY_SELECTED, ADD_SERIES, RADARR_GET_FOLDERS, \
    SONARR_GET_FOLDERS, SEASON_SELECTED, SONARR_GET_QUALITY_PROFILES, \
    SEASON_SELECTION, CONFIRM_DELETE, DELETE, STOP, SEARCH_STARTED, MEDIA_TYPE_SELECTED = range(13)
